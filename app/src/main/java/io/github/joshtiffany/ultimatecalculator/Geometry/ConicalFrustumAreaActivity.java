...
public class ConicalFrustumAreaActivity extends AppCompatActivity {
    private Button calc;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_conical_frustum_area);
        uisetup();
        ...
        calc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (baseTV.getText().length() > 0 && heightTV.getText().length() > 0 && topTV.getText().length() > 0) {
                    ...
                    area = Math.PI * height * (base + top) + Math.PI * (top * top + base * base);
    ...
    public void uisetup() {
        calc = findViewById(R.id.confruArCalcBTN);
        baseTV = findViewById(R.id.confruArBaseInputTV);
        heightTV = findViewById(R.id.confruArHeightInputTV);
        topTV = findViewById(R.id.confruArTopInputTV);
        result = findViewById(R.id.confruArVolumeOutputTV);
